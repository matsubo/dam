...
export function ObservationChart({
  ...
  slug: string;
  /** 有効貯水容量 — used for both the 貯水率 line and the reference markLine. */
      ...
      ...(capacityM3 && capacityM3 > 0
        ? {
            markLine: {
              ...
              label: {
                // Both callers pass active_capacity_m3 (有効貯水容量), not 総貯水容量.
                formatter: `有効貯水容量 ${fmtVolume(capacityM3)}`,
