...
export const SOURCE_DETAILS: Record<string, SourceDetail> = {
  ...
  damnet: {
    ...
    license:
      'サイト表記は「『ダム便覧』内の文章、画像、データなどすべての内容の無断転載を禁じます」。出典明示による一括再利用を認める記載は確認できず、諸元は同協会の有償刊行物「ダム年鑑」由来。本サイトの月次取り込みは許諾を照会中。写真は 2026-09-10 に利用停止 (media-policy が写真ごとの使用条件または個別問い合わせを求めており、著作権も撮影者に帰属するため)。',
    cadence: '月 1 回 (master:refresh:damnet cron / 毎月 5 日 03:00 UTC)',
    what: '利水容量・有効貯水容量, 目的, 型式, 堤頂長, 流域面積, 湛水面積, 着工年, 事業者, 施工者, ダム湖名。',
    label: 'ダム便覧',
  },
  wikipedia: {
