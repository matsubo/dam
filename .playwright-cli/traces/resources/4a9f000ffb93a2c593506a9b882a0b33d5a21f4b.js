...
((e) => {
    ...
    for (var t, i; e.length && e[0] !== document; ) {
      if (
        ...
        ('absolute' === t || 'relative' === t || 'fixed' === t) &&
          ((i = Number.parseInt(e.css('zIndex'), 10)), !isNaN(i) && 0 !== i))
      )
        return i;
      e = e.parent();
    }
  ...
  (e.ui = e.ui || {}),
    ...
    e.extend(e.expr[':'], {
      data: e.expr.createPseudo
        ? e.expr.createPseudo((t) => (i) => !!e.data(i, t))
        : (t, i, s) => !!e.data(t, s[3]),
      focusable: (i) => t(i, !isNaN(e.attr(i, 'tabindex'))),
      tabbable: (i) => {
    ...
    e('<a>').outerWidth(1).jquery ||
      e.each(['Width', 'Height'], (t, i) => {
        function s(t, i, s, a) {
          return (
            e.each(n, function () {
              (i -= Number.parseFloat(e.css(t, 'padding' + this)) || 0),
                s && (i -= Number.parseFloat(e.css(t, 'border' + this + 'Width')) || 0),
                a && (i -= Number.parseFloat(e.css(t, 'margin' + this)) || 0);
            }),
            i
          );
        }
          ...
          for (var i, s, n = e(this[0]); n.length && n[0] !== document; ) {
            if (
              ...
              ('absolute' === i || 'relative' === i || 'fixed' === i) &&
                ((s = Number.parseInt(n.css('zIndex'), 10)), !isNaN(s) && 0 !== s))
            )
              return s;
            n = n.parent();
          }
  ...
  (e.cleanData = ((t) => (i) => {
    ...
    (e.widget = (t, i, s) => {
      ...
      return (
        ...
        (n = l + '-' + t),
        s || ((s = i), (i = e.Widget)),
        (e.expr[':'][n.toLowerCase()] = (t) => !!e.data(t, n)),
        (e[l] = e[l] || {}),
        (a = e[l][t]),
        (o = e[l][t] =
          function (e, t) {
        ...
        a
          ? (e.each(a._childConstructors, (t, i) => {
              var s = i.prototype;
  ...
  e(document).mouseup(() => {
    ...
    e.widget('ui.mouse', {
      ...
      _mouseInit: function () {
        this.element
          .bind('mousedown.' + this.widgetName, (e) => this._mouseDown(e))
          .bind('click.' + this.widgetName, (i) =>
            ...
            ? ((this.mouseDelayMet = !this.options.delay),
              ...
              ((this._mouseStarted = this._mouseStart(t) !== !1), !this._mouseStarted)
                ...
                : (!0 === e.data(t.target, this.widgetName + '.preventClickEvent') &&
                  ...
                  (this._mouseMoveDelegate = (e) => this._mouseMove(e)),
                  (this._mouseUpDelegate = (e) => this._mouseUp(e)),
                  this.document
    ...
    (() => {
      function t(e, t, i) {
        return [
          Number.parseFloat(e[0]) * (p.test(e[0]) ? t / 100 : 1),
          Number.parseFloat(e[1]) * (p.test(e[1]) ? i / 100 : 1),
        ];
      }
      function i(t, i) {
        return Number.parseInt(e.css(t, i), 10) || 0;
      }
      function s(t) {
        var i = t[0];
        return 9 === i.nodeType
    ...
    e.widget('ui.draggable', e.ui.mouse, {
      ...
      _mouseCapture: function (t) {
        ...
        return (
          ...
          this.helper || i.disabled || e(t.target).closest('.ui-resizable-handle').length > 0
            ? !1
      ...
      _getParentOffset: function () {
        ...
        return (
          ...
          {
            top: t.top + (Number.parseInt(this.offsetParent.css('borderTopWidth'), 10) || 0),
            left: t.left + (Number.parseInt(this.offsetParent.css('borderLeftWidth'), 10) || 0),
          }
        );
      },
                ...
                : n.containment.constructor === Array
                  ...
                  : ('parent' === n.containment && (n.containment = this.helper[0].parentNode),
                    ...
                    s &&
                      ...
                      (this.containment = [
                        (Number.parseInt(i.css('borderLeftWidth'), 10) || 0) +
                          (Number.parseInt(i.css('paddingLeft'), 10) || 0),
                        (Number.parseInt(i.css('borderTopWidth'), 10) || 0) +
                          (Number.parseInt(i.css('paddingTop'), 10) || 0),
                        (t ? Math.max(s.scrollWidth, s.offsetWidth) : s.offsetWidth) -
                          (Number.parseInt(i.css('borderRightWidth'), 10) || 0) -
                          (Number.parseInt(i.css('paddingRight'), 10) || 0) -
                          this.helperProportions.width -
                          this.margins.left -
                          this.margins.right,
                        (t ? Math.max(s.scrollHeight, s.offsetHeight) : s.offsetHeight) -
                          (Number.parseInt(i.css('borderBottomWidth'), 10) || 0) -
                          (Number.parseInt(i.css('paddingBottom'), 10) || 0) -
                          this.helperProportions.height -
                          this.margins.top -
                          this.margins.bottom,
                      ]),
      ...
      _generatePosition: function (e, t) {
        ...
        return (
          ...
          t &&
            ...
            o.grid &&
              ((n = o.grid[1]
                ? this.originalPageY + Math.round((l - this.originalPageY) / o.grid[1]) * o.grid[1]
                : this.originalPageY),
              (l = i
                ...
                : n),
              (a = o.grid[0]
                ? this.originalPageX + Math.round((h - this.originalPageX) / o.grid[0]) * o.grid[0]
                : this.originalPageX),
              (h = i
      ...
      start: (t, i, s) => {
        ...
        (s.sortables = []),
          e(s.options.connectToSortable).each(function () {
            ...
            i &&
              !i.options.disabled &&
              (s.sortables.push(i), i.refreshPositions(), i._trigger('activate', t, n));
          });
      },
      stop: (t, i, s) => {
        var n = e.extend({}, i, { item: s.element });
        (s.cancelHelperRemoval = !1),
          e.each(s.sortables, function () {
            this.isOver
              ...
              : ((this.cancelHelperRemoval = !0), this._trigger('deactivate', t, n));
          });
      },
      drag: (t, i, s) => {
        e.each(s.sortables, function () {
    ...
    e.ui.plugin.add('draggable', 'scroll', {
      ...
      drag: (t, i, s) => {
        ...
        o !== r && 'HTML' !== o.tagName
          ? ((n.axis && 'x' === n.axis) ||
              (s.overflowOffset.top + o.offsetHeight - t.pageY < n.scrollSensitivity
                ? (o.scrollTop = a = o.scrollTop + n.scrollSpeed)
                : t.pageY - s.overflowOffset.top < n.scrollSensitivity &&
                  (o.scrollTop = a = o.scrollTop - n.scrollSpeed)),
            (n.axis && 'y' === n.axis) ||
              (s.overflowOffset.left + o.offsetWidth - t.pageX < n.scrollSensitivity
          ...
          : ((n.axis && 'x' === n.axis) ||
            ...
            (n.axis && 'y' === n.axis) ||
              (t.pageX - e(r).scrollLeft() < n.scrollSensitivity
                ...
                : e(window).width() - (t.pageX - e(r).scrollLeft()) < n.scrollSensitivity &&
                  (a = e(r).scrollLeft(e(r).scrollLeft() + n.scrollSpeed)))),
    ...
    e.ui.plugin.add('draggable', 'snap', {
      start: (t, i, s) => {
        var n = s.options;
        (s.snapElements = []),
          e(n.snap.constructor !== String ? n.snap.items || ':data(ui-draggable)' : n.snap).each(
            function () {
              var t = e(this),
                i = t.offset();
              this !== s.element[0] &&
      ...
      drag: (t, i, s) => {
        ...
        for (c = s.snapElements.length - 1; c >= 0; c--)
          (h = s.snapElements[c].left - s.margins.left),
            ...
            u - m > b ||
            y > d + m ||
            !e.contains(s.snapElements[c].item.ownerDocument, s.snapElements[c].item)
              ...
              : ('inner' !== f.snapMode &&
                  ...
                  r &&
                    (i.position.left = s._convertPositionTo('relative', { top: 0, left: l }).left)),
                (p = n || a || o || r),
                'outer' !== f.snapMode &&
                  ((n = m >= Math.abs(u - y)),
                  (a = m >= Math.abs(d - b)),
                  ...
                  o &&
                    (i.position.left = s._convertPositionTo('relative', { top: 0, left: h }).left),
                  r &&
                    (i.position.left = s._convertPositionTo('relative', {
                      top: 0,
      ...
      start: function (t, i, s) {
        var n,
          ...
          o = e
            ...
            .sort(
              (t, i) =>
                (Number.parseInt(e(t).css('zIndex'), 10) || 0) -
                (Number.parseInt(e(i).css('zIndex'), 10) || 0),
            );
        o.length &&
          ((n = Number.parseInt(e(o[0]).css('zIndex'), 10) || 0),
          e(o).each(function (t) {
    ...
    e.widget('ui.droppable', {
      ...
      _create: function () {
        ...
        (this.isover = !1),
          (this.isout = !0),
          (this.accept = e.isFunction(s) ? s : (e) => e.is(s)),
            ...
            if (!this.options.disabled && !this.greedyChild && this.visible) {
              ...
              r &&
                (this.options.greedy &&
                  ...
                  a.length &&
                    ((s = e(a[0]).droppable('instance')), (s.greedyChild = 'isover' === r))),
    ...
    e.widget('ui.resizable', e.ui.mouse, {
      ...
      _num: (e) => Number.parseInt(e, 10) || 0,
      _isNumber: (e) => !isNaN(Number.parseInt(e, 10)),
      _hasScroll: (t, i) => {
      ...
      _mouseStart: function (t) {
        ...
        return (
          ...
          a.containment &&
            ((i += e(a.containment).scrollLeft() || 0), (s += e(a.containment).scrollTop() || 0)),
      ...
      _mouseStop: function (t) {
        ...
        return (
          this._helper &&
            ...
            (n = s && this._hasScroll(i[0], 'left') ? 0 : this.sizeDiff.height),
            (a = s ? 0 : this.sizeDiff.width),
            (o = { width: this.helper.width() - a, height: this.helper.height() - n }),
            (r =
              Number.parseInt(this.element.css('left'), 10) +
                (this.position.left - this.originalPosition.left) || null),
            (h =
              Number.parseInt(this.element.css('top'), 10) +
      ...
      _updateRatio: function (e) {
        ...
        return (
          ...
          'nw' === s &&
            ((e.top = t.top + (i.height - e.height)), (e.left = t.left + (i.width - e.width))),
          e
        );
      },
      ...
      _getPaddingPlusBorderDimensions: (e) => {
        for (
          ...
          (i[t] = Number.parseInt(s[t], 10) || 0), (i[t] += Number.parseInt(n[t], 10) || 0);
    ...
    e.ui.plugin.add('resizable', 'animate', {
      stop: function (t) {
        var i = e(this).resizable('instance'),
          ...
          l =
            Number.parseInt(i.element.css('left'), 10) +
              (i.position.left - i.originalPosition.left) || null,
          u =
            Number.parseInt(i.element.css('top'), 10) + (i.position.top - i.originalPosition.top) ||
            null;
        i.element.animate(e.extend(h, u && l ? { top: u, left: l } : {}), {
          ...
          step: () => {
            var s = {
              width: Number.parseInt(i.element.css('width'), 10),
              height: Number.parseInt(i.element.css('height'), 10),
              top: Number.parseInt(i.element.css('top'), 10),
              left: Number.parseInt(i.element.css('left'), 10),
            };
      ...
      start: function () {
        ...
        c &&
          ...
          /document/.test(d) || d === document
            ...
            : ((t = e(c)),
              (i = []),
              e(['Top', 'Right', 'Left', 'Bottom']).each((e, s) => {
      ...
      resize: function (t) {
        ...
        c[0] !== document && /static/.test(c.css('position')) && (d = h),
          l.left < (o._helper ? h.left : 0) &&
            ((o.size.width =
              o.size.width + (o._helper ? o.position.left - h.left : o.position.left - d.left)),
            u && ((o.size.height = o.size.width / o.aspectRatio), (p = !1)),
            (o.position.left = r.helper ? h.left : 0)),
          l.top < (o._helper ? h.top : 0) &&
            ((o.size.height =
              o.size.height + (o._helper ? o.position.top - h.top : o.position.top)),
          ...
          (s = Math.abs(
            o.sizeDiff.height + (o._helper ? o.offset.top - d.top : o.offset.top - h.top),
          )),
          ...
          s = (t) => {
            e(t).each(function () {
              ...
              t.data('ui-resizable-alsoresize', {
                ...
                left: Number.parseInt(t.css('left'), 10),
                top: Number.parseInt(t.css('top'), 10),
              });
            });
          };
          ...
          /^(se|s|e)$/.test(r)
            ...
            : /^(ne)$/.test(r)
              ...
              : /^(sw)$/.test(r)
                ...
                : ((0 >= f - u || 0 >= p - l) && (t = i._getPaddingPlusBorderDimensions(this)),
                  f - u > 0
    ...
    e.widget('ui.selectable', e.ui.mouse, {
      ...
      _create: function () {
        ...
        this.element.addClass('ui-selectable'),
          (this.dragged = !1),
          (this.refresh = () => {
            (t = e(this.options.filter, this.element[0])),
          ...
          return (
            ...
            this.selectees.each(function () {
              ...
              i &&
                ...
                ('touch' === n.tolerance
                  ? (l = !(i.left > r || a > i.right || i.top > h || o > i.bottom))
                  : 'fit' === n.tolerance &&
    ...
    e.widget('ui.sortable', e.ui.mouse, {
      ...
      _isOverAxis: (e, t, i) => e >= t && t + i > e,
      _isFloating: (e) =>
        /left|right/.test(e.css('float')) || /inline|table-cell/.test(e.css('display')),
      _create: function () {
        var e = this.options;
        (this.containerCache = {}),
        ...
        if (t) {
          if (
            ...
            (a && 'x' !== a) ||
              ...
              (this.reverting = !0),
              e(this.helper).animate(o, Number.parseInt(this.options.revert, 10) || 500, () => {
                this._clear(t);
              });
      ...
      _intersectsWithPointer: function (e) {
        var t =
            'x' === this.options.axis ||
            this._isOverAxis(this.positionAbs.top + this.offset.click.top, e.top, e.height),
          i =
            'y' === this.options.axis ||
            this._isOverAxis(this.positionAbs.left + this.offset.click.left, e.left, e.width),
          s = t && i,
      ...
      _removeCurrentsFromItems: function () {
        ...
        this.items = e.grep(this.items, (e) => {
                ...
                a &&
                  ...
                  (d.push([
                    e.isFunction(a.options.items)
                      ? a.options.items.call(a.element[0], t, { item: this.currentItem })
                ...
                (n.height() ||
                  n.height(
                    t.currentItem.innerHeight() -
                      Number.parseInt(t.currentItem.css('paddingTop') || 0, 10) -
                      Number.parseInt(t.currentItem.css('paddingBottom') || 0, 10),
                  ),
                n.width() ||
                  n.width(
                    t.currentItem.innerWidth() -
                      Number.parseInt(t.currentItem.css('paddingLeft') || 0, 10) -
                      Number.parseInt(t.currentItem.css('paddingRight') || 0, 10),
                  ));
            },
          })),
      ...
      _createHelper: function (t) {
        ...
        return (
          s.parents('body').length ||
            e('parent' !== i.appendTo ? i.appendTo : this.currentItem[0].parentNode)[0].appendChild(
              s[0],
            ),
      ...
      _cacheMargins: function () {
        this.margins = {
          left: Number.parseInt(this.currentItem.css('marginLeft'), 10) || 0,
          top: Number.parseInt(this.currentItem.css('marginTop'), 10) || 0,
        };
      },
      _cacheHelperProportions: function () {
        this.helperProportions = {
      ...
      _setContainment: function () {
        ...
        'parent' === n.containment && (n.containment = this.helper[0].parentNode),
          ...
          /^(document|window|parent)$/.test(n.containment) ||
            ...
            (this.containment = [
              i.left +
                (Number.parseInt(e(t).css('borderLeftWidth'), 10) || 0) +
                (Number.parseInt(e(t).css('paddingLeft'), 10) || 0) -
                this.margins.left,
              i.top +
                (Number.parseInt(e(t).css('borderTopWidth'), 10) || 0) +
                (Number.parseInt(e(t).css('paddingTop'), 10) || 0) -
                this.margins.top,
              i.left +
                (s ? Math.max(t.scrollWidth, t.offsetWidth) : t.offsetWidth) -
                (Number.parseInt(e(t).css('borderLeftWidth'), 10) || 0) -
                (Number.parseInt(e(t).css('paddingRight'), 10) || 0) -
                this.helperProportions.width -
                this.margins.left,
              i.top +
                (s ? Math.max(t.scrollHeight, t.offsetHeight) : t.offsetHeight) -
                (Number.parseInt(e(t).css('borderTopWidth'), 10) || 0) -
                (Number.parseInt(e(t).css('paddingBottom'), 10) || 0) -
                this.helperProportions.height -
                this.margins.top,
            ]));
      },
          ...
          this.originalPosition &&
            ...
            n.grid &&
              ...
              (o = this.containment
                ...
                : i),
              (s =
                this.originalPageX + Math.round((a - this.originalPageX) / n.grid[0]) * n.grid[0]),
              (a = this.containment
    ...
    e.widget('ui.menu', {
        ...
        switch (t.keyCode) {
          ...
          default:
            (o = !1),
              ...
              (i =
                a && -1 !== i.index(this.active.next()) ? this.active.nextAll('.ui-menu-item') : i),
      ...
      _activate: function (e) {
        this.active.is('.ui-state-disabled') ||
          (this.active.is("[aria-haspopup='true']") ? this.expand(e) : this.select(e));
      },
      refresh: function () {
        var t,
          i,
      ...
      _scrollIntoView: function (t) {
        var i, s, n, a, o, r;
        this._hasScroll() &&
          ((i = Number.parseFloat(e.css(this.activeMenu[0], 'borderTopWidth')) || 0),
          (s = Number.parseFloat(e.css(this.activeMenu[0], 'paddingTop')) || 0),
      ...
      _closeOnDocumentClick: (t) => !e(t.target).closest('.ui-menu').length,
      _isDivider: (e) => !/[^\-\u2014\u2013\s]/.test(e.text()),
      collapse: function (e) {
    ...
    e.widget('ui.autocomplete', {
          ...
          this._on(this.element, {
            ...
            blur: function (e) {
              return this.cancelBlur
                ...
                : (clearTimeout(this.searching), this.close(e), this._change(e), void 0);
            },
          }),
          this._initSource(),
          (this.menu = e('<ul>')
      ...
      _renderMenu: function (t, i) {
        e.each(i, (e, i) => {
          this._renderItemData(t, i);
        });
      },
      _renderItemData: function (e, t) {
        return this._renderItem(e, t).data('ui-autocomplete-item', t);
      },
      _renderItem: (t, i) => e('<li>').text(i.label).appendTo(t),
      _move: function (e, t) {
  ...
  e.widget('ui.button', {
    ...
    _create: function () {
      ...
      var t = this,
        ...
        n = s ? '' : 'ui-state-active';
      null === i.label &&
        (i.label = 'input' === this.type ? this.buttonElement.val() : this.buttonElement.html()),
        ...
        'checkbox' === this.type
          ? this.buttonElement.bind('click' + this.eventNamespace, () => (i.disabled ? !1 : void 0))
          : 'radio' === this.type
    ...
    _resetButton: function () {
      ...
      s.primary || s.secondary
        ? (this.options.text &&
            a.push('ui-button-text-icon' + (n ? 's' : s.primary ? '-primary' : '-secondary')),
          s.primary &&
            t.prepend("<span class='ui-button-icon-primary ui-icon " + s.primary + "'></span>"),
          s.secondary &&
            t.append("<span class='ui-button-icon-secondary ui-icon " + s.secondary + "'></span>"),
          this.options.text ||
  ...
  e.extend(n.prototype, {
    ...
    _autoSize: function (e) {
      if (this._get(e, 'autoSize') && !e.inline) {
        ...
        o.match(/[DM]/) &&
          ...
          a.setDate(
            t(this._get(e, o.match(/DD/) ? 'dayNames' : 'dayNamesShort')) + 20 - a.getDay(),
          )),
      ...
      return 2 === arguments.length && 'string' == typeof i
        ...
        : ((n = i || {}),
          ...
          l &&
            ...
            'disabled' in n &&
              (n.disabled ? this._disableDatepicker(t) : this._enableDatepicker(t)),
    ...
    _selectMonthYear: function (t, i, s) {
      ...
      (a['selected' + ('M' === s ? 'Month' : 'Year')] = a['draw' + ('M' === s ? 'Month' : 'Year')] =
        Number.parseInt(i.options[i.selectedIndex].value, 10)),
    ...
    parseDate: function (t, i, s) {
      ...
      var n,
        ...
        u = 'string' != typeof l ? l : (new Date().getFullYear() % 100) + Number.parseInt(l, 10),
        ...
        x = (e) => {
          ...
          return (h += o[0].length), Number.parseInt(o[0], 10);
        },
        w = (t, s, n) => {
          var a = -1,
            o = e
      ...
      if (
        (-1 === m
          ...
          : 100 > m &&
            (m +=
              new Date().getFullYear() - (new Date().getFullYear() % 100) + (u >= m ? 0 : -100)),
        y > -1)
      )
        for (g = 1, v = y; ; ) {
    ...
    W3C: 'yy-mm-dd',
    _ticksTo1970:
      1e7 * 60 * 60 * 24 * (718685 + Math.floor(492.5) - Math.floor(19.7) + Math.floor(4.925)),
    formatDate: function (e, t, i) {
      ...
      var s,
        ...
        l = (e, t, i) => {
          var s = '' + t;
          if (h(e)) while (i > s.length) s = '0' + s;
          return s;
        },
        u = (e, t, i, s) => (h(e) ? s[t] : i[t]),
        d = '',
        c = !1;
      if (t)
        ...
        a = (i) => {
          ...
          for (
            ...
            switch (l[2] || 'd') {
              case 'd':
              case 'D':
                r += Number.parseInt(l[1], 10);
                break;
              case 'w':
              case 'W':
                r += 7 * Number.parseInt(l[1], 10);
                break;
              case 'm':
              case 'M':
                (o += Number.parseInt(l[1], 10)),
                  (r = Math.min(r, e.datepicker._getDaysInMonth(a, o)));
                break;
              case 'y':
              case 'Y':
                (a += Number.parseInt(l[1], 10)),
                  (r = Math.min(r, e.datepicker._getDaysInMonth(a, o)));
            }
            l = h.exec(i);
          }
      ...
      if ((0 > Z && ((Z += 12), et--), $))
        for (
          t = this._daylightSavingAdjust(
            new Date($.getFullYear(), $.getMonth() - K[0] * K[1] + 1, $.getDate()),
          ),
            t = X && X > t ? X : t;
        ...
        e.drawMonth = Z,
          ...
          l = B
            ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" +
              ...
              '</div>'
            : '',
          u = Number.parseInt(this._get(e, 'firstDay'), 10),
          u = isNaN(u) ? 0 : u,
        ...
        for (k = '', this.maxRows = 4, T = 0; K[1] > T; T++) {
          ...
          for (
            M +=
              ...
              this._generateMonthYearHeader(e, Z, et, X, $, w > 0 || T > 0, f, m) +
              ...
              (O = g ? g.apply(e.input ? e.input[0] : null, [H]) : [!0, '']),
                ...
                (E +=
                  ...
                  (j && !v
                    ...
                    : ' ' +
                      O[1] +
                      (H.getTime() === G.getTime() ? ' ' + this._currentClass : '') +
          ...
          Z++,
            ...
            (M +=
              ...
              (Q
                ? '</div>' +
                  (K[0] > 0 && T === K[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : '')
                : '')),
            (k += M);
        }
        _ += k;
        ...
        if (((e.yearshtml = ''), a || !v)) b += "<span class='ui-datepicker-year'>" + i + '</span>';
          ...
          for (
            d = this._get(e, 'yearRange').split(':'),
              ...
              p = (e) => {
                var t = e.match(/c[+\-].*/)
                  ? i + Number.parseInt(e.substring(1), 10)
                  : e.match(/[+\-].*/)
                    ? c + Number.parseInt(e, 10)
    ...
    _getFirstDayOfMonth: (e, t) => new Date(e, t, 1).getDay(),
    ...
    _getFormatConfig: function (e) {
      ...
      return (
        (t = 'string' != typeof t ? t : (new Date().getFullYear() % 100) + Number.parseInt(t, 10)),
        {
          shortYearCutoff: t,
    ...
    e.widget('ui.dialog', {
      ...
      _moveToTop: function (t, i) {
        ...
        return (
          a >= +this.uiDialog.css('z-index') && (this.uiDialog.css('z-index', a + 1), (s = !0)),
        ...
        return this._isOpen
          ...
          : ((this._isOpen = !0),
            ...
            this._show(this.uiDialog, this.options.show, () => {
              this._focusTabbable(), this._trigger('focus');
            }),
          ...
          e.isEmptyObject(i) || (e.isArray(i) && !i.length)
            ...
            : (e.each(i, (i, s) => {
                ...
                (s = e.isFunction(s) ? { click: s, text: i } : s),
                  ...
                  (n = s.click),
                  (s.click = () => {
                    n.apply(this.element[0], arguments);
                  }),
                  (a = { icons: s.icons, text: s.showText }),
                  delete s.icons,
                  delete s.showText,
                  e('<button></button>', s).button(a).appendTo(this.uiButtonSet);
              }),
      ...
      _setOptions: function (t) {
        ...
        e.each(t, (e, t) => {
          this._setOption(e, t),
            e in this.sizeRelatedOptions && (s = !0),
            e in this.resizableRelatedOptions && (n[e] = t);
        }),
              ...
              this._on(this.document, {
                focusin: function (e) {
                  t ||
                    ...
                    (e.preventDefault(), this._trackingInstances()[0]._focusTabbable());
                },
              }),
            (this.overlay = e('<div>')
    ...
    e.widget('ui.progressbar', {
      ...
      value: function (e) {
        return void 0 === e
          ? this.options.value
          : ((this.options.value = this._constrainedValue(e)), this._refreshValue(), void 0);
      },
    ...
    e.widget('ui.selectmenu', {
      ...
      _drawButton: function () {
        ...
        (this.label = e("label[for='" + this.ids.element + "']").attr('for', this.ids.button)),
          ...
          this.button.one('focusin', () => {
            this.menuItems || this._refreshMenu();
          }),
          ...
          (this.menuInstance = this.menu
            .menu({
              ...
              select: (e, i) => {
                e.preventDefault(),
                  this._setSelection(),
                  this._select(i.item.data('ui-selectmenu-item'), e);
              },
              focus: (e, i) => {
                var s = i.item.data('ui-selectmenu-item');
                null != this.focusIndex &&
                  s.index !== this.focusIndex &&
                  (this._trigger('focus', e, { item: s }), this.isOpen || this._select(s, e)),
                  (this.focusIndex = s.index),
                  this.button.attr('aria-activedescendant', this.menuItems.eq(s.index).attr('id'));
              },
            })
            .menu('instance')),
          this.menu.addClass('ui-corner-bottom').removeClass('ui-corner-all'),
          this.menuInstance._off(this.menu, 'mouseleave'),
          (this.menuInstance._closeOnDocumentClick = () => !1),
          (this.menuInstance._isDivider = () => !1);
      },
      refresh: function () {
        this._refreshMenu(),
          ...
          a.optgroup !== n &&
            (e('<li>', {
              class:
                ...
                (a.element.parent('optgroup').prop('disabled') ? ' ui-state-disabled' : ''),
              text: a.optgroup,
            }).appendTo(t),
            (n = a.optgroup)),
            this._renderItemData(t, a);
        });
      },
      _renderItemData: function (e, t) {
      ...
      _renderItem: function (t, i) {
        var s = e('<li>');
        return (
          i.disabled && s.addClass('ui-state-disabled'), this._setText(s, i.label), s.appendTo(t)
        );
      },
      _setText: (e, t) => {
        t ? e.text(t) : e.html('&#160;');
      ...
      _setSelection: function () {
        ...
        this.range &&
          (window.getSelection
            ? ((e = window.getSelection()), e.removeAllRanges(), e.addRange(this.range))
            : this.range.select(),
          this.button.focus());
      },
      _documentClick: {
        mousedown: function (t) {
          this.isOpen &&
            (e(t.target).closest('.ui-selectmenu-menu, #' + this.ids.button).length ||
              this.close(t));
        },
      },
      _buttonEvents: {
        mousedown: function () {
          var e;
          window.getSelection
            ? ((e = window.getSelection()), e.rangeCount && (this.range = e.getRangeAt(0)))
    ...
    e.widget('ui.slider', e.ui.mouse, {
        ...
        return d.disabled
          ...
          : ((this.elementSize = {
            ...
            this.handles.each(function (t) {
              ...
              (n > i || (n === i && (t === u._lastChangedValue || u.values(t) === d.min))) &&
                ((n = i), (a = e(this)), (o = t));
            }),
            (r = this._start(t, o)),
            r === !1
                ...
                (this._clickOffset = l
                  ...
                  : {
                      ...
                      top:
                        ...
                        h.top -
                        a.height() / 2 -
                        (Number.parseInt(a.css('borderTopWidth'), 10) || 0) -
                        (Number.parseInt(a.css('borderBottomWidth'), 10) || 0) +
                        (Number.parseInt(a.css('marginTop'), 10) || 0),
                    }),
        ...
        this.options.values && this.options.values.length
          ? ((s = this.values(t ? 0 : 1)),
            ...
            i !== this.values(t) &&
              ...
              a !== !1 && this.values(t, i)))
          : i !== this.value() &&
            ((a = this._trigger('slide', e, { handle: this.handles[t], value: i })),
            a !== !1 && this.value(i));
      },
      _stop: function (e, t) {
        var i = { handle: this.handles[t], value: this.value() };
      ...
      _trimAlignValue: function (e) {
        ...
        var t = this.options.step > 0 ? this.options.step : 1,
          ...
          s = e - i;
        return 2 * Math.abs(i) >= t && (s += i > 0 ? t : -t), Number.parseFloat(s.toFixed(5));
      },
      ...
      _handleEvents: {
        keydown: function (t) {
          ...
          switch (
            ((a = this.options.step),
            (s = n =
              this.options.values && this.options.values.length ? this.values(o) : this.value()),
            t.keyCode)
          ) {
            case e.ui.keyCode.HOME:
              n = this._valueMin();
    ...
    e.widget('ui.spinner', {
      ...
      _precision: function () {
        ...
        return (
          null !== this.options.min && (e = Math.max(e, this._precisionOf(this.options.min))), e
        );
      },
      _precisionOf: (e) => {
        var t = '' + e,
      ...
      _adjustValue: function (e) {
        ...
        return (
          ...
          (e = t + i),
          (e = Number.parseFloat(e.toFixed(this._precision()))),
    ...
    e.widget('ui.tabs', {
        ...
        (this.running = !1),
          ...
          e.isArray(i.disabled) &&
            (i.disabled = e
              .unique(
                i.disabled.concat(
                  e.map(this.tabs.filter('.ui-state-disabled'), (e) => this.tabs.index(e)),
                ),
              )
              .sort()),
          (this.active =
            this.options.active !== !1 && this.anchors.length ? this._findActive(i.active) : e()),
          this._refresh(),
      ...
      _initialActive: function () {
        ...
        return (
          null === t &&
            (s &&
              this.tabs.each((i, n) => (e(n).attr('aria-controls') === s ? ((t = i), !1) : void 0)),
      ...
      _sanitizeSelector: (e) => (e ? e.replace(/[!"$%&'()*+,.\/:;<=>?@\[\]\^`{|}~]/g, '\\$&') : ''),
      refresh: function () {
        var t = this.options,
          i = this.tablist.children(':has(a[href])');
        (t.disabled = e.map(i.filter('.ui-state-disabled'), (e) => i.index(e))),
          this._processTabs(),
        ...
        (this.tablist = this._getList()
          ...
          this.anchors.each((i, s) => {
            ...
            this._isLocal(s)
              ? ((n = s.hash),
                (o = n.substring(1)),
                (a = this.element.find(this._sanitizeSelector(n))))
              : ((o = h.attr('aria-controls') || e({}).uniqueId()[0].id),
                (n = '#' + o),
                (a = this.element.find(n)),
                a.length ||
                  ((a = this._createPanel(o)), a.insertAfter(this.panels[i - 1] || this.tablist)),
                a.attr('aria-live', 'polite')),
              a.length && (this.panels = this.panels.add(a)),
      ...
      enable: function (t) {
        ...
        i !== !1 &&
          (void 0 === t
            ...
            : ((t = this._getIndex(t)),
              (i = e.isArray(i)
                ? e.map(i, (e) => (e !== t ? e : null))
                : e.map(this.tabs, (e, i) => (i !== t ? i : null)))),
        ...
        this._isLocal(a[0]) ||
          ...
          this.xhr &&
            ...
            this.xhr
              .success((e) => {
                setTimeout(() => {
                  o.html(e), this._trigger('load', i, r);
                }, 1);
              })
              .complete((e, t) => {
                setTimeout(() => {
                  'abort' === t && this.panels.stop(!1, !0),
                    n.removeClass('ui-tabs-loading'),
                    o.removeAttr('aria-busy'),
                    e === this.xhr && delete this.xhr;
                }, 1);
              })));
      },
      _ajaxSettings: function (t, i, s) {
        return {
          url: t.attr('href'),
          beforeSend: (t, a) =>
            this._trigger('beforeLoad', i, e.extend({ jqXHR: t, ajaxSettings: a }, s)),
        };
      },
    ...
    e.widget('ui.tooltip', {
      ...
      _setOption: function (t, i) {
        return 'disabled' === t
          ...
          : (this._super(t, i),
            'content' === t &&
              e.each(this.tooltips, (e, t) => {
                this._updateContent(t.element);
              }),
            void 0);
      },
      _disable: function () {
        e.each(this.tooltips, (i, s) => {
          var n = e.Event('blur');
          (n.target = n.currentTarget = s.element[0]), this.close(n, !0);
        }),
          this.element
            .find(this.options.items)
            .addBack()
          ...
          t &&
            ...
            s.parents().each(function () {
              ...
              s.data('ui-tooltip-open') &&
                ((t = e.Event('blur')), (t.target = t.currentTarget = this), i.close(t, !0)),
                s.attr('title') &&
                  (s.uniqueId(),
      ...
      _open: function (t, i, s) {
        ...
        if (s) {
          ...
          i.is('[title]') &&
            ...
            this.liveRegion.children().hide(),
            s.clone ? ((l = s.clone()), l.removeAttr('id').find('[id]').removeAttr('id')) : (l = s),
  ...
  (e.effects = { effect: {} }),
      ...
      function i(e, t, i) {
        ...
        return null == e
          ? i || !t.def
            ? null
            : t.def
          : ((e = s.floor ? ~~e : Number.parseFloat(e)),
        ...
        return (
          ...
          f(h, (e, a) => {
            var o,
              ...
              l = a.space || 'rgba';
            return h
              ? ((o = s[l](h)), (s[u[l].cache] = o[u[l].cache]), (n = s._rgba = o._rgba), !1)
              : t;
          }),
        ...
        h = [
          {
            ...
            parse: (e) => [e[1], e[2], e[3], e[4]],
          },
          {
            re: /rgba?\(\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,
            parse: (e) => [2.55 * e[1], 2.55 * e[2], 2.55 * e[3], e[4]],
          },
          {
          ...
          },
          {
            ...
            space: 'hsla',
            parse: (e) => [e[1], e[2] / 100, e[3] / 100, e[4]],
          },
        ],
        l = (e.Color = (t, i, s, n) => new e.Color.fn.parse(t, i, s, n)),
        u = {
          rgba: {
            props: {
              red: { idx: 0, type: 'byte' },
        ...
        (l.fn = e.extend(l.prototype, {
              ...
              'string' === c
                ...
                : 'array' === c
                  ...
                  : 'object' === c
                    ? (n instanceof l
                        ? f(u, (e, t) => {
                            n[t.cache] && (this[t.cache] = n[t.cache].slice());
                          })
                        : f(u, (t, s) => {
                            var a = s.cache;
                            f(s.props, (e, t) => {
                              if (!this[a] && s.to) {
                                ...
                                this[a] = s.to(this._rgba);
                              }
                              this[a][t.idx] = i(n[e], t, !0);
                            }),
                              this[a] &&
                                0 > e.inArray(null, this[a].slice(0, 3)) &&
                                ((this[a][3] = 1), s.from && (this._rgba = s.from(this[a])));
                          }),
                      this)
                    : t
            );
          ...
          is: function (e) {
            ...
            return (
              f(u, (e, a) => {
                ...
                return (
                  r &&
                    ((o = this[a.cache] || (a.to && a.to(this._rgba)) || []),
                    f(a.props, (e, i) => (null != r[i.idx] ? (s = r[i.idx] === o[i.idx]) : t))),
                  s
                );
              }),
              s
              ...
              f(a.props, (e, n) => {
                ...
                null !== l &&
                  (null === o
                    ? (h[a] = l)
                    : (u.mod &&
                        (l - o > u.mod / 2 ? (o += u.mod) : o - l > u.mod / 2 && (o -= u.mod)),
                      (h[a] = i((l - o) * t + o, n))));
              }),
              this[n](h)
            );
          ...
          blend: function (t) {
            ...
            var i = this._rgba.slice(),
              s = i.pop(),
              n = l(t)._rgba;
            return l(e.map(i, (e, t) => (1 - s) * n[t] + s * e));
          },
          toRgbaString: function () {
            var t = 'rgba(',
              i = e.map(this._rgba, (e, t) => (null == e ? (t > 2 ? 1 : 0) : e));
          ...
          toHslaString: function () {
            var t = 'hsla(',
              i = e.map(
                this.hsla(),
                (e, t) => (
                  null == e && (e = t > 2 ? 1 : 0), t && 3 > t && (e = Math.round(100 * e) + '%'), e
                ),
              );
          ...
          toHexString: function (t) {
            ...
            return (
              ...
              '#' +
                e
                  .map(i, (e) => ((e = (e || 0).toString(16)), 1 === e.length ? '0' + e : e))
                  .join('')
            );
          },
          toString: function () {
                  ...
                  return 'undefined' === o
                    ...
                    : ('function' === o && ((n = n.call(this, u)), (o = e.type(n))),
                      null == n && i.empty
                        ...
                        : ('string' === o &&
                            ((a = r.exec(n)),
                            a && (n = u + Number.parseFloat(a[2]) * ('+' === a[1] ? 1 : -1))),
                          (l[i.idx] = n),
                          this[h](l)));
                });
            });
    ...
    (() => {
      ...
      function i(t, i) {
        ...
        for (s in i)
          (a = i[s]),
            t[s] !== a && (n[s] || ((e.fx.step[s] || !isNaN(Number.parseFloat(a))) && (o[s] = a)));
        return o;
      }
    ...
    (() => {
      ...
      e.extend(e.effects, {
        ...
        setMode: (e, t) => ('toggle' === t && (t = e.is(':hidden') ? 'show' : 'hide'), t),
        getBaseline: (e, t) => {
          var i, s;
          switch (e[0]) {
            case 'top':
          ...
          return (
            ...
            'static' === t.css('position')
              ...
              : (e.extend(i, { position: t.css('position'), zIndex: t.css('z-index') }),
                e.each(['top', 'left', 'bottom', 'right'], (e, s) => {
                  (i[s] = t.css(s)), isNaN(Number.parseInt(i[s], 10)) && (i[s] = 'auto');
                }),
        ...
        removeWrapper: (t) => {
          ...
          return (
            t.parent().is('.ui-effects-wrapper') &&
              (t.parent().replaceWith(t), (t[0] === i || e.contains(t[0], i)) && e(i).focus()),
            t
          );
        },
        setTransition: (t, i, s, n) => (
          (n = n || {}),
          e.each(i, (e, i) => {
            var a = t.cssUnit(i);
            a[0] > 0 && (n[i] = a[0] * s + a[1]);
        ...
        e.fn.extend({
          ...
          cssUnit: function (t) {
            ...
            return (
              e.each(['em', 'px', '%', 'pt'], (e, t) => {
                i.indexOf(t) > 0 && (s = [Number.parseFloat(i), t]);
              }),
              s
            );
          },
    ...
    (() => {
      ...
      e.each(['Quad', 'Cubic', 'Quart', 'Quint', 'Expo'], (e, i) => {
        ...
        e.each(t, (t, i) => {
          (e.easing['easeIn' + t] = i),
            (e.easing['easeOut' + t] = (e) => 1 - i(1 - e)),
            (e.easing['easeInOut' + t] = (e) => (0.5 > e ? i(2 * e) / 2 : 1 - i(-2 * e + 2) / 2));
        });
    })(),
    e.effects,
        ...
        for (h = g.top + a * y, u = a - (d - 1) / 2, o = 0; c > o; o++)
          (r = g.left + o * v),
            ...
            p
              ...
              .animate(
                { left: r + (m ? 0 : l * v), top: h + (m ? 0 : u * y), opacity: m ? 1 : 0 },
                t.duration || 500,
                t.easing,
                s,
              );
    ...
    (e.effects.effect.fold = function (t, i) {
      ...
      e.effects.save(a, o),
        ...
        d && (u = (Number.parseInt(d[1], 10) / 100) * n[l ? 0 : 1]),
    ...
    (e.effects.effect.scale = function (t, i) {
      var s = e(this),
        ...
        o =
          Number.parseInt(t.percent, 10) ||
          (0 === Number.parseInt(t.percent, 10) ? 0 : 'hide' === a ? 0 : 100),
        r = t.direction || 'both',
        h = t.origin,
        l = {
          height: s.height(),
      ...
      (n.effect = 'size'),
        ...
        (n.from =
          t.from || ('show' === a ? { height: 0, width: 0, outerHeight: 0, outerWidth: 0 } : l)),
        (n.to = {
          height: l.height * u.y,
          width: l.width * u.x,
    ...
    (e.effects.effect.puff = function (t, i) {
      var s = e(this),
        ...
        a = 'hide' === n,
        o = Number.parseInt(t.percent, 10) || 150,
        r = o / 100,
        h = {
          height: s.height(),
          width: s.width(),
