...
!((e, t) => {
  'object' == typeof module && 'object' == typeof module.exports
    ...
    : t(e);
})('undefined' != typeof window ? window : this, (C, e) => {
  var t = [],
    r = Object.getPrototypeOf,
    s = t.slice,
    g = t.flat ? (e) => t.flat.call(e) : (e) => t.concat.apply([], e),
    u = t.push,
    i = t.indexOf,
    n = {},
    o = n.toString,
  ...
  (S.fn = S.prototype =
    ...
    S.extend({
      ...
      inArray: (e, t, n) => (null == t ? -1 : i.call(t, e, n)),
      merge: (e, t) => {
  ...
  var d = ((n) => {
    var e,
      ...
      ae = be((e) => !0 === e.disabled && 'fieldset' === e.nodeName.toLowerCase(), {
        dir: 'parentNode',
        next: 'legend',
      });
    try {
    ...
    function de(t) {
      return (e) => 'input' === e.nodeName.toLowerCase() && e.type === t;
    }
    function he(n) {
      return (e) => {
      ...
      (e) => {
        ...
        return (
          r != C &&
            ...
            (d.attributes = ce((e) => ((e.className = 'i'), !e.getAttribute('className')))),
            (d.getElementsByTagName = ce(
              (e) => (e.appendChild(C.createComment('')), !e.getElementsByTagName('*').length),
            )),
    ...
    (se.matches = (e, t) => se(e, null, null, t)),
    (se.matchesSelector = (e, t) => {
    ...
    (se.contains = (e, t) => ((e.ownerDocument || e) != C && T(e), y(e, t))),
    (se.attr = (e, t) => {
    ...
    ((b = se.selectors =
      {
        ...
        filter: {
          TAG: (e) => {
            ...
            return '*' === e ? () => !0 : (e) => e.nodeName && e.nodeName.toLowerCase() === t;
          },
          CLASS: (e) => {
            var t = m[e + ' '];
            return (
        ...
        pseudos: {
          not: le((e) => {
            ...
            return s[S]
              ...
              : (e, t, n) => ((r[0] = e), s(r, null, n, i), (r[0] = null), !i.pop());
          }),
          has: le((t) => (e) => 0 < se(t, e).length),
          contains: le(
            (t) => ((t = t.replace(te, ne)), (e) => -1 < (e.textContent || o(e)).indexOf(t)),
          ),
          lang: le(
            (n) => (
          ...
          parent: (e) => !b.pseudos.empty(e),
          header: (e) => J.test(e.nodeName),
          input: (e) => Q.test(e.nodeName),
          button: (e) => {
            var t = e.nodeName.toLowerCase();
    ...
    return (
      ...
      T(),
      (d.sortDetached = ce((e) => 1 & e.compareDocumentPosition(C.createElement('fieldset')))),
      ce((e) => ((e.innerHTML = "<a href='#'></a>"), '#' === e.firstChild.getAttribute('href'))) ||
      ...
      ce((e) => null == e.getAttribute('disabled')) ||
        fe(R, (e, t, n) => {
          var r;
          if (!n)
            return !0 === e[t]
    ...
    S.each(
      {
        ...
        parents: (e) => h(e, 'parentNode'),
        parentsUntil: (e, t, n) => h(e, 'parentNode', n),
        next: (e) => O(e, 'nextSibling'),
        prev: (e) => O(e, 'previousSibling'),
        nextAll: (e) => h(e, 'nextSibling'),
        prevAll: (e) => h(e, 'previousSibling'),
        nextUntil: (e, t, n) => h(e, 'nextSibling', n),
        prevUntil: (e, t, n) => h(e, 'previousSibling', n),
        siblings: (e) => T((e.parentNode || {}).firstChild, e),
        children: (e) => T(e.firstChild),
        contents: (e) =>
          null != e.contentDocument && r(e.contentDocument)
            ? e.contentDocument
  ...
  (S.Callbacks = (r) => {
    ...
    var i,
      ...
      f = {
        ...
        has: (e) => (e ? -1 < S.inArray(e, s) : 0 < s.length),
        empty: function () {
          return s && (s = []), this;
        },
        disable: function () {
      ...
      Deferred: (e) => {
        var o = [
          ...
          a = {
            ...
            promise: (e) => (null != e ? S.extend(e, a) : a),
          },
          s = {};
        return (
          S.each(o, (e, t) => {
  ...
  var $ = (e, t, n, r, i, o, a) => {
      ...
      if ('object' === w(n)) for (s in ((i = !0), n)) $(e, t, s, n[s], !0, o, a);
        ...
        ((i = !0),
        m(r) || (a = !0),
        l && (a ? (t.call(e, r), (t = null)) : ((l = t), (t = (e, t, n) => l.call(S(e), n)))),
        t)
      )
  ...
  var V = (e) => 1 === e.nodeType || 9 === e.nodeType || !+e.nodeType;
  function G() {
  ...
  S.extend({
    hasData: (e) => Q.hasData(e) || Y.hasData(e),
    data: (e, t, n) => Q.access(e, t, n),
    removeData: (e, t) => {
      Q.remove(e, t);
    },
    _data: (e, t, n) => Y.access(e, t, n),
    _removeData: (e, t) => {
      Y.remove(e, t);
    },
  }),
    ...
    S.fn.extend({
      ...
      promise: function (e, t) {
        var n,
          ...
          a = this.length,
          s = () => {
            --r || i.resolveWith(this, [this]);
          };
        'string' != typeof e && ((t = e), (e = void 0)), (e = e || 'fx');
        while (a--) (n = Y.get(this[a], e + 'queueHooks')) && n.empty && (r++, n.empty.add(s));
  ...
  var ee = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    ie = (e) => S.contains(e.ownerDocument, e),
    oe = { composed: !0 };
  re.getRootNode &&
    (ie = (e) => S.contains(e.ownerDocument, e) || e.getRootNode(oe) === e.ownerDocument);
  var ae = (e, t) =>
  ...
  (S.event = {
      ...
      if (V(t)) {
        n.handler && ((n = (o = n).handler), (i = o.selector)),
          ...
          (a = v.handle) ||
            (a = v.handle =
              (e) =>
                'undefined' != typeof S && S.event.triggered !== e.type
    ...
    fix: (e) => (e[S.expando] ? e : new S.Event(e)),
    special: {
      load: { noBubble: !0 },
      click: {
        setup: function (e) {
  ...
  !(() => {
    ...
    function t(e) {
      return Math.round(Number.parseFloat(e));
    }
    var n,
      r,
      i,
    ...
    l.style &&
      ...
      S.extend(y, {
        boxSizingReliable: () => (e(), r),
        pixelBoxStyles: () => (e(), o),
        pixelPosition: () => (e(), n),
        reliableMarginLeft: () => (e(), s),
        scrollboxSize: () => (e(), i),
        reliableTrDimensions: () => {
          ...
          return (
            null == a &&
              ...
              (a =
                Number.parseInt(r.height, 10) +
                  Number.parseInt(r.borderTopWidth, 10) +
                  Number.parseInt(r.borderBottomWidth, 10) ===
                t.offsetHeight),
              re.removeChild(e)),
            a
          );
  ...
  function Je(e, t, n) {
    ...
    return (
      ((!y.boxSizingReliable() && i) ||
        ...
        'auto' === a ||
        (!Number.parseFloat(a) && 'inline' === S.css(e, 'display', !1, r))) &&
        e.getClientRects().length &&
        ((i = 'border-box' === S.css(e, 'boxSizing', !1, r)), (o = s in e) && (a = e[s])),
      (a = Number.parseFloat(a) || 0) + Qe(e, t, n || (i ? 'border' : 'content'), o, r, a) + 'px'
    );
  }
  ...
  S.extend({
    ...
    css: (e, t, n, r) => {
      ...
      return (
        ...
        '' === n || n ? ((o = Number.parseFloat(i)), !0 === n || isFinite(o) ? o || 0 : i) : i
      );
    },
  }),
    ...
    (S.cssHooks.marginLeft = Fe(y.reliableMarginLeft, (e, t) => {
      if (t)
        return (
          (Number.parseFloat(We(e, 'marginLeft')) ||
            e.getBoundingClientRect().left -
              Me(e, { marginLeft: 0 }, () => e.getBoundingClientRect().left)) + 'px'
        );
    })),
  ...
  S.fn.extend({
    ...
    (ct = { set: (e, t, n) => (!1 === t ? S.removeAttr(e, n) : e.setAttribute(n, n), n) }),
  ...
  S.fn.extend({
          ...
          this.each(function (e) {
            ...
            1 === this.nodeType &&
              (null == (t = i ? n.call(this, e, S(this).val()) : n)
                ...
                : 'number' == typeof t
                  ? (t += '')
                  : Array.isArray(t) && (t = S.map(t, (e) => (null == e ? '' : e + ''))),
    ...
    S.each(['radio', 'checkbox'], function () {
      (S.valHooks[this] = {
        ...
        y.checkOn ||
          (S.valHooks[this].get = (e) => (null === e.getAttribute('value') ? 'on' : e.value));
    }),
  ...
  S.parseXML = (e) => {
    ...
    return (
      ...
      (t && !n) ||
        S.error('Invalid XML: ' + (n ? S.map(n.childNodes, (e) => e.textContent).join('\n') : e)),
      t
    );
  };
  var Ct = /\[\]$/,
        ...
        return this.map(function () {
          ...
          .map(function (e, t) {
            ...
            return null == n
              ? null
              : Array.isArray(n)
                ? S.map(n, (e) => ({ name: t.name, value: e.replace(Et, '\r\n') }))
  ...
  (Mt.href = bt.href),
    S.extend({
      ...
      ajaxSetup: (e, t) => (t ? Ft(Ft(e, S.ajaxSettings), t) : Ft(S.ajaxSettings, e)),
      ajaxPrefilter: It(Ot),
      ajaxTransport: It(Pt),
      ajax: (e, t) => {
        ...
        var c,
          ...
          T = {
            ...
            getAllResponseHeaders: () => (h ? p : null),
      ...
      getJSON: (e, t, n) => S.get(e, t, n, 'json'),
      getScript: (e, t) => S.get(e, void 0, t, 'script'),
    }),
    S.each(['get', 'post'], (e, i) => {
      S[i] = (e, t, n, r) => (
    ...
    (S.expr.pseudos.hidden = (e) => !S.expr.pseudos.visible(e)),
    (S.expr.pseudos.visible = (e) =>
  ...
  (y.cors = !!$t && 'withCredentials' in $t),
    ...
    S.ajaxSetup({
      ...
      converters: { 'text script': (e) => (S.globalEval(e), e) },
    }),
  ...
  S.ajaxSetup({
    ...
    S.ajaxPrefilter('json jsonp', (e, t, n) => {
      ...
      if (a || 'jsonp' === e.dataTypes[0])
        return (
          ...
          (e.converters['script json'] = () => (o || S.error(r + ' was not called'), o[0])),
          (e.dataTypes[0] = 'json'),
          (i = C[r]),
          (C[r] = () => {
            o = arguments;
      ...
      return (
        ...
        0 < this.length &&
          S.ajax({ url: e, type: i || 'GET', dataType: 'html', data: t })
            .done((e) => {
              (o = arguments), this.html(r ? S('<div>').append(S.parseHTML(e)).find(r) : e);
            })
            .always(
              n &&
                ((e, t) => {
    ...
    (S.expr.pseudos.animated = (t) => S.grep(S.timers, (e) => t === e.elem).length),
    (S.offset = {
      setOffset: (e, t, n) => {
        var r,
          i,
        ...
        'static' === l && (e.style.position = 'relative'),
          ...
          ('absolute' === l || 'fixed' === l) && -1 < (o + u).indexOf('auto')
            ...
            : ((a = Number.parseFloat(o) || 0), (i = Number.parseFloat(u) || 0)),
  ...
  (S.proxy = (e, t) => {
    ...
    (S.isNumeric = (e) => {
      var t = S.type(e);
      return ('number' === t || 'string' === t) && !isNaN(e - Number.parseFloat(e));
    }),
    (S.trim = (e) => (null == e ? '' : (e + '').replace(Xt, ''))),
    'function' == typeof define && define.amd && define('jquery', [], () => S);
  var Vt = C.jQuery,
    Gt = C.$;
  return (
    (S.noConflict = (e) => (C.$ === S && (C.$ = Gt), e && C.jQuery === S && (C.jQuery = Vt), S)),
